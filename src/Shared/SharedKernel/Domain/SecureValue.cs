...
public sealed record BlindIndex
{
    ...
    public static BlindIndex Compute(string plaintext, byte[] salt)
    {
        ...
        var hash = hmac.ComputeHash(System.Text.Encoding.UTF8.GetBytes(plaintext));
...
public sealed record SecureValue
{
    ...
    public string Decrypt(byte[] decryptionKey)
    {
        ...
        var plaintextBytes = decryptor.TransformFinalBlock(Encrypted.Ciphertext, 0, Encrypted.Ciphertext.Length);

...
///     - Structured for reporting and compliance audits
/// </summary>
public sealed record AuditEntry
{
    ...
    ///     Examples: "user_123", "admin_456", "system@netcommerce.com"
    /// </summary>
    ...
    ///     This is the "explainability" layer for business users.
    /// </summary>
    ...
    ///     This is the bridge between Compliance Team and DevOps Team.
    /// </summary>
    public string CorrelationId { get; init; } = string.Empty;

    /// <summary>
    ///     Optional: IP address from which the action was performed.
    ///     Useful for security investigations and geographic compliance.
    /// </summary>
    public string? IpAddress { get; init; }

    /// <summary>
    ///     Optional: User agent (browser/API client) that initiated the action.
    /// </summary>

...
///     - Consider archiving to cold storage after 2-3 years
/// </summary>
public interface IAuditRepository
{
    /// <summary>
    ///     Stores an audit entry in the immutable ledger.
    ///     This is typically called by AuditMiddleware automatically.
    /// </summary>
    ...
    ///     Used for: Customer support UI, compliance reports, legal discovery
    /// </summary>

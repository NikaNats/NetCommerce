...
/// <summary>
///     DEPRECATED: Use NetCommerce.Kernel.Security.Authentication.TokenIntrospectionMiddleware instead.
///     The types are re-exported via type aliases in TypeAliases.cs.
/// </summary>
[Obsolete("Use NetCommerce.Kernel.Security.Authentication.TokenIntrospectionMiddleware instead. " +
          "This namespace is deprecated and will be removed in a future version.")]
public static class TokenIntrospectionDeprecatedWarning
{
